...
class SyncServiceTest {
    ...
    void upsertEventDeduplicatesByNaturalKey() {
        F1ExternalApi dummy = new F1ExternalApi() {
            @Override
            public java.util.List<EventDto> listEvents(Integer year, String type, String country) {
        ...
        SyncService service = new SyncService(syncStatusRepository, eventRepository, eventExternalRefRepository, dummy);
